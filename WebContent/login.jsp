...
<body>
	<%-- <html:form action="/LoginAction" onsubmit="return validateform()">
	...
	Login ID:-	<html:text property="loginid" /><br />
	...
	<!-- <form action="/LoginAction" name="myform" onsubmit="return validateform()">
